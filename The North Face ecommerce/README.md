# The North Face E-commerce - NLP & Système de Recommandation
...
## Livrables
- **Notebook principal en français** : `the_north_face_fr.ipynb`
- **Notebook en anglais** : `the_north_face_en.ipynb`
- **Visualisations générées** : `wordclouds_clusters.png`, `wordclouds_topics.png`
- **Code source complet (GitHub)** : https://github.com/philippetoso-commits/jedha_portfolio
- **Lien direct dossier projet** : https://github.com/philippetoso-commits/jedha_portfolio/tree/main/The%20North%20Face%20ecommerce
...
- Résultat : Identification de micro-catégories de produits très similaires, utiles pour alimenter un système de recommandation. Les regroupements plus larges sont ensuite interprétés avec les sujets LSA.
