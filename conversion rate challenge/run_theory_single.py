...
print("="*80)
print("🧬 SINGLE MODEL THEORY : GENERATION & THRESHOLD OPTIMIZATION")
print("="*80)

SEED = 42

# Optimal Config from Grid Search
# F1=0.77089 (±0.00898) | AUC=0.98552
PARAMS = {
    'learning_rate': 0.01,
    'max_depth': 6,
    'n_estimators': 500,
    ...
    'n_jobs': -1,
    'random_state': SEED,
    'monotone_constraints': '(0, 0, 0, -1, 1)' # Age decrease, Pages increase
}
...
submission.to_csv('submission_THEORY_SINGLE.csv', index=False)
print("✅ Submission Saved: submission_THEORY_SINGLE.csv")
